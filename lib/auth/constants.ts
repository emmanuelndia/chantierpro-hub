...
export const WEB_ROUTE_ROLE_MAP: Record<string, Role[]> = {
  ...
  '/web/photos': ['BE_MANAGER', 'PROJECT_MANAGER', 'DIRECTION', 'ADMIN'],
  '/web/reports': [
    'COORDINATOR',
    'GENERAL_SUPERVISOR',
    'BE_MANAGER',
  ...
  '/web/planning': ['GENERAL_SUPERVISOR', 'BE_MANAGER', 'PROJECT_MANAGER', 'DIRECTION', 'ADMIN'],
  ...
  '/web/manager': ['GENERAL_SUPERVISOR', 'BE_MANAGER', 'PROJECT_MANAGER', 'DIRECTION', 'ADMIN'],
  '/admin/users': ['ADMIN'],
