...
const MOBILE_PROJECT_ROLES: readonly Role[] = [Role.PROJECT_MANAGER, Role.NEGOTIATION_MANAGER, Role.DIRECTION, Role.AUDITOR];
...
export function canMutateMobileProjects(role: Role) {
  return role === Role.PROJECT_MANAGER || role === Role.NEGOTIATION_MANAGER || role === Role.DIRECTION;
}
