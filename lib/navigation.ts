...
export const mobileTabNavigation: readonly MobileNavigationItem[] = [
  {
    ...
    label: 'Accueil',
    icon: 'home',
    roles: ['SUPERVISOR', 'RESOURCE', 'EXTERNAL_RESOURCE', 'COORDINATOR', 'GENERAL_SUPERVISOR', 'BE_RESOURCE', 'NEGOTIATION_RESOURCE', 'DRIVER', 'BE_MANAGER', 'NEGOTIATION_MANAGER', 'FLEET_MANAGER', 'PROJECT_MANAGER', 'DIRECTION', 'HR', 'ADMIN', 'OFFICE_STAFF'],
  },
  {
  ...
  },
  {
    ...
    label: 'Taches',
    icon: 'calendar',
    roles: ['SUPERVISOR', 'RESOURCE', 'EXTERNAL_RESOURCE', 'COORDINATOR', 'GENERAL_SUPERVISOR', 'BE_RESOURCE', 'DRIVER', 'PROJECT_MANAGER'],
  },
  {
