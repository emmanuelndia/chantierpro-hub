...
export const mobileTabNavigation: readonly MobileNavigationItem[] = [
  ...
  },
  {
    ...
    label: 'Taches',
    icon: 'calendar',
    roles: ['SUPERVISOR', 'RESOURCE', 'EXTERNAL_RESOURCE', 'COORDINATOR', 'GENERAL_SUPERVISOR', 'BE_RESOURCE', 'FLEET_RESOURCE', 'PROJECT_MANAGER'],
  },
  {
  ...
  },
  {
    ...
    label: 'Photo',
    icon: 'photo',
    roles: ['SUPERVISOR', 'RESOURCE', 'EXTERNAL_RESOURCE', 'COORDINATOR', 'GENERAL_SUPERVISOR', 'BE_RESOURCE', 'NEGOTIATION_RESOURCE', 'NEGOTIATION_MANAGER', 'FLEET_RESOURCE', 'PROJECT_MANAGER'],
  },
  {
